...
/**
 * Default transport: POST JSON via fetch. Throws a {@link TransportError} on a
 * non-2xx response (carrying status + parsed Retry-After); network failures
 * reject with the underlying fetch error.
 */
